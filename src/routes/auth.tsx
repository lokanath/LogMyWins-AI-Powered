      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-14">
        ...
        >
          <button
            ...
            className="mb-5 flex w-full items-center justify-center gap-3 rounded-lg bg-white/80 px-4 py-2.5 text-sm font-medium text-ink ring-1 ring-line transition-transform hover:-translate-y-px active:translate-y-0"
          >
